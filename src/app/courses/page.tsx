        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Course title (e.g. 微積分, 物理, AI)..."
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Professor (e.g. 黃, 張, 王)..."
              className="w-full bg-theme-bg border border-theme-border focus:border-indigo-500 rounded-2xl pl-10 pr-4 py-2.5 text-sm text-theme-text placeholder-theme-muted focus:outline-none transition-all"
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Course Code (e.g. MATH1010, CS)..."
              className="w-full bg-theme-bg border border-theme-border focus:border-indigo-500 rounded-2xl pl-10 pr-4 py-2.5 text-sm text-theme-text placeholder-theme-muted focus:outline-none transition-all"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {courses.map((c) => (
            <motion.div
              ...
              className="p-5 rounded-3xl bg-theme-card border border-theme-border hover:border-indigo-500/40 transition-all space-y-3 relative group shadow-sm"
            >

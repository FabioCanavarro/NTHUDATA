...
export default function HomePage() {
  ...
  return (
    <div className="space-y-8 pb-12">
      {/* Hero Welcome Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-theme-card via-theme-card-hover to-theme-card border border-theme-border p-8 shadow-2xl">
        ...
        <div className="relative z-10 space-y-3 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-theme-primary/20 border border-theme-primary/40 text-theme-primary text-xs font-bold uppercase tracking-wider">
            ...
            NTHU Unified Campus OS
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-theme-text tracking-tight">
          ...
          <p className="text-sm md:text-base text-theme-muted leading-relaxed">
            Real-time IoT data, YouBike 2.0 availability, MQTT laundry machines, campus shuttle buses, dining venues, and custom starred dashboard widgets.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-5 rounded-3xl bg-theme-card border border-theme-border flex items-center gap-4 hover:border-theme-primary/50 transition-all shadow-sm">
          <div className="p-3 rounded-2xl bg-cyan-500/20 text-cyan-400 border border-cyan-500/30">
            <Bike className="w-6 h-6" />
          </div>
          <div>
            <p className="text-xs text-theme-muted font-medium">Available YouBikes</p>
            <h3 className="text-2xl font-bold text-theme-text">{loading ? '...' : totalBikesNearCampus}</h3>
            <p className="text-[11px] text-cyan-400 font-semibold">{totalFreeDocksNearCampus} empty docks</p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-3xl bg-theme-card border border-theme-border flex items-center gap-4 hover:border-theme-primary/50 transition-all shadow-sm">
          ...
          <div>
            <p className="text-xs text-theme-muted font-medium">Free Washers</p>
            <h3 className="text-2xl font-bold text-theme-text">{loading ? '...' : totalFreeWashers}</h3>
            <p className="text-[11px] text-emerald-400 font-semibold">Live MQTT Status</p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-3xl bg-theme-card border border-theme-border flex items-center gap-4 hover:border-theme-primary/50 transition-all shadow-sm">
          ...
          <div>
            <p className="text-xs text-theme-muted font-medium">Shuttle Routes</p>
            <h3 className="text-2xl font-bold text-theme-text">4 Active</h3>
            <p className="text-[11px] text-purple-400 font-semibold">Main & Nanda Line</p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-3xl bg-theme-card border border-theme-border flex items-center gap-4 hover:border-theme-primary/50 transition-all shadow-sm">
          ...
          <div>
            <p className="text-xs text-theme-muted font-medium">Campus Power</p>
            <h3 className="text-2xl font-bold text-theme-text">14.2 MW</h3>
            <p className="text-[11px] text-amber-400 font-semibold">Realtime Load</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        {favorites.length === 0 ? (
          <div className="p-8 text-center rounded-3xl bg-theme-card/60 border border-dashed border-theme-border space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {favorites.map((fav) => (
              <motion.div
                ...
                className="p-5 rounded-3xl bg-theme-card border border-theme-border hover:border-theme-primary/40 transition-all space-y-3 relative group shadow-sm"
              >
      ...
      <div className="space-y-4 pt-4">
        <h2 className="text-xl font-bold text-theme-text tracking-tight">Explore Campus Apps</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/youbike" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-cyan-500/50 hover:shadow-glow transition-all space-y-3">
          ...
          <Link href="/laundry" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-emerald-500/50 hover:shadow-glow transition-all space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-theme-text group-hover:text-emerald-400 transition-colors">
                  Laundry Hub (MQTT)
                </h3>
                <p className="text-xs text-theme-muted mt-1">
          ...
          <Link href="/buses" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-purple-500/50 hover:shadow-glow transition-all space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-theme-text group-hover:text-purple-400 transition-colors">
          ...
          <Link href="/courses" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-indigo-500/50 hover:shadow-glow transition-all space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-theme-text group-hover:text-indigo-400 transition-colors">
          ...
          <Link href="/dining" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-rose-500/50 hover:shadow-glow transition-all space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-theme-text group-hover:text-rose-400 transition-colors">
                  Food & Dining Venues
                </h3>
                <p className="text-xs text-theme-muted mt-1">
          ...
          <Link href="/lost-and-found" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-teal-500/50 hover:shadow-glow transition-all space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-theme-text group-hover:text-teal-400 transition-colors">
                  Lost & Found Portal
                </h3>
                <p className="text-xs text-theme-muted mt-1">
          ...
          <Link href="/gym" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-amber-500/50 hover:shadow-glow transition-all space-y-3">
              ...
              <div>
                <h3 className="text-base font-bold text-theme-text group-hover:text-amber-400 transition-colors">
          ...
          <Link href="/docs" className="group">
            <div className="p-6 rounded-3xl bg-theme-card border border-theme-border hover:border-theme-primary hover:shadow-glow transition-all space-y-3">
              <div className="w-12 h-12 rounded-2xl bg-theme-primary/20 text-theme-primary flex items-center justify-center group-hover:scale-110 transition-transform">
